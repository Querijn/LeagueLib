...
namespace Spek
{
	...
	f64  Duration::operator /(const Duration& a_Duration) const { return (f64)m_Value / (f64)a_Duration.m_Value; }
	...
	Duration Duration::FromNanosecondsF(f64 a_Nanoseconds)			{ return Duration((i64)(a_Nanoseconds)); }
	Duration Duration::FromMicrosecondsF(f64 a_Microseconds)		{ return Duration((i64)(a_Microseconds						  * 1000.0)); }
	Duration Duration::FromMillisecondsF(f64 a_Milliseconds)		{ return Duration((i64)(a_Milliseconds				 * 1000.0 * 1000.0)); }
	Duration Duration::FromSecondsF(f64 a_Seconds)					{ return Duration((i64)(a_Seconds			* 1000.0 * 1000.0 * 1000.0)); }
	Duration Duration::FromMinutesF(f64 a_Minutes)					{ return Duration((i64)(a_Minutes	* 60.0  * 1000.0 * 1000.0 * 1000.0)); }
